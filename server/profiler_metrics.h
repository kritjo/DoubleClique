...
typedef enum {
    ...
    PROF_SERVER_POLL_SLOT_LOAD,
    PROF_SERVER_POLL_KEY_ALLOC,
    PROF_SERVER_POLL_KEY_COPY,
    PROF_SERVER_POLL_KEY_HASH,
    PROF_SERVER_POLL_DISPATCH_TOTAL,
    PROF_SERVER_POLL_DISPATCH_PUT,
    PROF_SERVER_POLL_DISPATCH_GET1,
    PROF_SERVER_POLL_DISPATCH_GET2,
    PROF_SERVER_POLL_DISPATCH_GET1_HASH_MISMATCH,
    PROF_SERVER_POLL_KEY_FREE,
    PROF_SERVER_POLL_BOOKKEEPING,
    ...
    PROF_SERVER_GET1_SETUP,
    PROF_SERVER_GET1_WRITEBACK_INIT,
    PROF_SERVER_GET1_ACK_FINALIZE,
    PROF_SERVER_GET1_METRICS_EMIT,
    PROF_SERVER_GET1_RECORD_OVERHEAD,
    PROF_SERVER_GET1_RESIDUAL,
