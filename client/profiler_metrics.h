...
typedef enum {
    ...
    PROF_CLIENT_GET2_ACK_PHASE1_DECISION_TIMEOUT,
    PROF_CLIENT_GET2_ACK_PHASE1_MAIN_PATH,
    PROF_CLIENT_GET2_ACK_PHASE1_PRE_SCAN,
    PROF_CLIENT_GET2_ACK_PHASE1_MAIN_PATH_OVERHEAD,
    ...
    PROF_CLIENT_GET1_MUTEX_LOCK_WAIT,
    PROF_CLIENT_GET1_PROMISE_SETUP,
    PROF_CLIENT_GET1_WAIT_FOR_RESULT,
    PROF_CLIENT_GET1_TIMEOUT_CLEANUP,
    PROF_CLIENT_GET1_COMPLETION_CLEANUP,
    PROF_CLIENT_GET1_MUTEX_UNLOCK,
    ...
    PROF_CLIENT_GET1_CALLBACKS_TOTAL,
    PROF_CLIENT_GET1_RESIDUAL,
